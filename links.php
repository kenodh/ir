		    ...
		    <div id="page" class="box">
    			<div id="page-in" class="box">
					<div id="strip" class="box noprint">
						...
						<hr class="noscreen">
						<p id="currentPosition">You are here: <strong>Links</strong></p>
						<hr class="noscreen">
					</div> <!-- /strip -->
					<div id="content">
						<div class="article">
							<h2><span>Links</span></h2>
				                		<p class="info noprint">
		        				            <span class="newstitle">Links to other useful web sites</span><span class="noscreen">&nbsp;</span>
				        		        </p>
										<p><span id="deskpoints">
<span class="linkItem">
												<a href="http://royalcollegestudybuddyclub.webs.com/" target="_blank"><strong>Study Buddy Club of Royal College </strong></a>
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td width="18%">Description : </td>
														<td>Study Buddy is the coordination between friends in order to fulfill and exchange their educational needs which can be expanded up to global level.</td>
													</tr>
